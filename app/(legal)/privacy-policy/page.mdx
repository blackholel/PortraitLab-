# Privacy Policy for PortraitAI

## Introduction

Welcome to PortraitAI, an **AI Portrait Art Platform** designed to help you create stunning artistic portraits using AI technology. At PortraitAI, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using PortraitAI:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use PortraitAI, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access PortraitAI, such as device type, operating system, and browser type.
...
**Copyright Owner**: [portraitai.app](https://portraitai.app)
**Email**: [support@portraitai.app](mailto:support@portraitai.app)

By using PortraitAI, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
